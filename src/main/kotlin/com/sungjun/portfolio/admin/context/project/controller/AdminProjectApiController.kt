...
import com.sungjun.portfolio.admin.context.project.form.ProjectForm
import com.sungjun.portfolio.admin.context.project.service.AdminProjectService
import com.sungjun.portfolio.admin.data.ApiResponse
...
class AdminProjectApiController(
    ...
    fun getProjectDetail(@PathVariable id: Long): TableDTO {
